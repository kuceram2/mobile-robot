...
def generate_launch_description():
    ...
    led_controller_spawner = Node(
     ...
     # Delay start of joint_state_broadcaster after `led_controller`
    ...
    set_led_service_server = Node(
        package="ros2_tutorials",
        executable="set_led_server",
        name='set_led_server',
        output='screen'
    )
    ...
    nodes = [
        ...
        led_controller_spawner,
        set_led_service_server,
